...
using Soundlinks.Shared.Abstractions.Repositories;

namespace Soundlinks.Shared.Infrastructure.Repositories
{
    /// <summary>
    /// Klasa implementująca podstawowe metody repozytorium.
    /// Implementuje <see cref="Soundlinks.Shared.Infrastructure.Repositories.BaseRepository{TEntity, TContext}" />
    /// Implementuje <see cref="Soundlinks.Shared.Abstractions.Repositories.ICrudRepository{TEntity}" />
    /// </summary>
    /// <typeparam name="TEntity">Typ obiektów repozytorium.</typeparam>
    /// <typeparam name="TContext">Typ kontekstu bazy danych</typeparam>
    /// <seealso cref="Soundlinks.Shared.Infrastructure.Repositories.BaseRepository{TEntity, TContext}" />
    /// <seealso cref="Soundlinks.Shared.Abstractions.Repositories.ICrudRepository{TEntity}" />
